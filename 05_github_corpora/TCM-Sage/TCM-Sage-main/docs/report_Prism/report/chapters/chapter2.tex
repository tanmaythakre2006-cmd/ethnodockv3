...
Several research institutions and corporations have developed TCM-specific AI systems \cite{wang2026tcmaidev}. HuatuoGPT, developed by CUHK Shenzhen, achieved an 88.1\% score on the TCM licensing exam \cite{huatuogpt2023}. Other systems include Qihuang 2.0 (Shuzhi Qihuang), a 32-billion-parameter multimodal model incorporating tongue and pulse image analysis, jointly developed by East China Normal University and Shanghai University of TCM \cite{qihuang2024ecnu}; and iFlytek's TCM diagnostic assistant, deployed across 107 primary care institutions in Bozhou, Anhui Province, serving over 350 TCM practitioners \cite{iflytek2024cnr}. These systems share a common design philosophy: direct diagnosis and prescription.
